!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var L = "fslightbox-types",
        F = "fslightbox-scrollbar-width";
      function I(e) {
        var t,
          n = e.props,
          o = 0,
      ...
      function X() {
        ...
        var c = function () {
            ...
            if (2 === o.readyState) {
              ...
              ((s = !0), u(r(o.getResponseHeader("content-type"))), l());
            }
          },
          a = function () {
            ((t = N), l());
        ...
        ((o.className = "".concat(s, "nav")),
            ...
            ((n.className = "".concat(s, "toolbar")),
              ...
              (function (e, t) {
                ...
                ((i.isFullscreenOpen = !!document.fullscreenElement),
                  i.isFullscreenOpen
                    ? ((n = Y(a, "24px", "0 0 950 1024", c)),
                      (a.title = "Exit fullscreen"))
                    : ((n = Y(a, "20px", "0 0 18 18", r)),
          ...
          t.length > 1 &&
            (function (e, t) {
              ...
              i.className = "".concat(s, "slide-number-container ").concat(a);
              var r = document.createElement("div");
              n.setSlideNumber = function (e) {
                return (r.innerHTML = e);
              };
              var c = document.createElement("div");
              ((c.className = "".concat(s, "slash")), (c.innerHTML = "/"));
      ...
      function te(e) {
        ...
        ((this.runPositiveSwipedXActions = function () {
          (void 0 === s.previous || (i("positive"), n.changeTo(s.previous)),
            i("zero"));
        }),
          (this.runNegativeSwipedXActions = function () {
            (void 0 === s.next || (i("negative"), n.changeTo(s.next)),
              i("zero"));
          }));
        var i = function (e) {
        ...
        ((this.runNoSwipeActions = function () {
          ...
          (this.runActions = function () {
            (s.swipedX > 0
              ...
              n.container.contains(n.slideSwipingHoverer) &&
                n.container.removeChild(n.slideSwipingHoverer),
      ...
      function se(e) {
        ...
        ((n = (t = e).core.classFacade),
          ...
          (n.removeFromEachElementClassIfContains = function (e, t) {
            for (var n = 0; n < o[e].length; n++) J(o[e][n], t);
          }),
          (function (e) {
          ...
          (function (e) {
            var t,
              n,
              o = e.collections.sourcesOutersTransformers,
              s = e.componentsServices,
              i = e.core,
              r = i.classFacade,
              ...
              f =
                ((t = function () {
                  r.removeFromEachElementClassIfContains("sourcesInners", g);
                }),
                (n = []),
                function () {
                  (n.push(!0),
            ...
            ((c.changeTo = function (e) {
              ((p.current = e),
                ...
                s.setSlideNumber(e + 1),
                a.displayStageSourcesIfNotYet());
            }),
              (c.jumpTo = function (e) {
                var t = p.current;
                (c.changeTo(e),
                  r.removeFromEachElementClassIfContains(Z, u),
                  J(d[t], m),
                  J(d[t], h),
                  d[t].classList.add(g),
                  J(d[e], m),
          ...
          (function (e) {
            ...
            o.listener = function (e) {
              ...
              (t && t.contains(e.target)
                ...
                n.removeFromEachElementClassIfContains(Z, u));
            };
          })(e),
          (function (e) {
      ...
      function ie(e) {
        ...
        ((n.isInitialized = !0),
          ...
          (function (e) {
            ...
            for (var s = 0; s < o.length; s++) V(e, s);
          })(e),
          i.length > 1 &&
            (function (e) {
          ...
          (function (e) {
            for (
              ...
              } else s.runActionsForSourceTypeAndIndex(A, r);
          })(e),
          t.dispatch("onInit"));
      }
      function re(e) {
        ...
        i.open = function () {
          ...
          ((h.current = o),
            p.isInitialized ? s.dispatch("onShow") : ie(e),
      ...
      function ce() {
        ...
        var i = o - s;
        return (localStorage.setItem(F, i.toString()), i);
      }
      function ae(e, t, n) {
        return (ae = (function () {
